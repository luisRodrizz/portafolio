...
export default function ProjectMiniCard({ project }) {
  return (
    <motion.article
      variants={fadeUp}
      className="group relative overflow-hidden rounded-[24px] border border-white/[0.06] bg-white/[0.02] p-5 transition duration-300 hover:-translate-y-1 hover:border-[#00f5a0]/20 hover:bg-white/[0.035] sm:rounded-[26px] sm:p-6 lg:rounded-[28px]"
    >
